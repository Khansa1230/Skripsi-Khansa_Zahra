                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4>Jumlah Mahasiswa Berdasarkan Jenis Sekolah</h4>
                            </div>
                            <form method="GET" action="<?php echo e(route('jumlah_mahasiswa_jenis_sekolah')); ?>" id="filter-form">
                                <?php echo csrf_field(); ?>
                                <div class="card-body">
...
<script src="https://cdn.jsdelivr.net/npm/chartjs-plugin-datalabels"></script>
 ...
 <script>
    ...
    const labels = query.map(item => item.jenis_sekolah); // Mengambil status dari query
...
<?php echo $__env->make('kerangka.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\skripsi\resources\views/mahasiswa/jenis_sekolah_mahasiswa.blade.php ENDPATH**/ ?>