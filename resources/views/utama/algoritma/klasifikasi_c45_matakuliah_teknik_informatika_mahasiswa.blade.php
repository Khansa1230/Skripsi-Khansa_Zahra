...
<div class="page-heading">
    ...
    <div class="card-header">
        <h4>
            ...
            <a href="{{ route('prediksi_mahasiswa_jurusan_teknik_informatika') }}" style="text-decoration: none; color: inherit;">
                Prediksi Jurusan Teknik Informatika
            </a>
        </h4>
    </div>
    <div class="card-body">
        <form method="POST" action="{{ route('klasifikasi_c45_mahasiswa_jurusan_teknik_informatika') }}">
            @csrf
