    ...
    <section class="section">
        <div class="card">
            <div class="card-header">
                <h4>
                    <a href="{{ route('klasifikasi_c45_mahasiswa_fisika') }}" style="text-decoration: none; color: inherit;">Klasifikasi Algoritma C45 Jurusan Fisika</a>
                     - Prediksi Jurusan Fisika
                </h4>
            </div>
            <form method="GET" action="{{ route('prediksi_mahasiswa_fisika') }}" id="filter-form">
                @csrf
                <div class="card-body">
