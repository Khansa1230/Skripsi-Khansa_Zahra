                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            ...
                            <form method="GET" action="<?php echo e(route('jumlah_mahasiswa_jenis_seleksi')); ?>" id="filter-form">
                                <?php echo csrf_field(); ?>
                                <div class="card-body">
...
<?php echo $__env->make('kerangka.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\skripsi\resources\views/mahasiswa/jenis_seleksi_mahasiswa.blade.php ENDPATH**/ ?>