...
class KlasifikasiC45AgribisnisController extends Controller
{
    public function klasifikasi_dan_evaluation_mahasiswa_agribisnis(Request $request)
    {
...
return view('algoritma.klasifikasi_c45_dan_prediksi_matakuliah_agribisnis_mahasiswa', compact('outputData', 'total1', 'columnMapping','years', 'predictedLulus', 'year', 'result1', 'total2', 
