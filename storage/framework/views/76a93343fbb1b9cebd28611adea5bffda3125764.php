    ...
    <section class="section">
        <div class="card">
            <div class="card-header">
                <h4>
                    <a href="<?php echo e(route('klasifikasi_c45_mahasiswa_kimia')); ?>" style="text-decoration: none; color: inherit;">Klasifikasi Algoritma C45 Jurusan Kimia</a>
                     - Prediksi Jurusan Kimia
                </h4>
            </div>
            <form method="GET" action="<?php echo e(route('prediksi_mahasiswa_kimia')); ?>" id="filter-form">
                <?php echo csrf_field(); ?>
                <div class="card-body">
...
<?php echo $__env->make('kerangka.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\skripsi\resources\views/algoritma/prediksi/prediksi_matakuliah_kimia_mahasiswa.blade.php ENDPATH**/ ?>