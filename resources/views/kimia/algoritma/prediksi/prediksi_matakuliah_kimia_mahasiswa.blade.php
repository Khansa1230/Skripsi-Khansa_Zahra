    ...
    <section class="section">
        <div class="card">
            <div class="card-header">
                <h4>
                    <a href="{{ route('klasifikasi_c45_mahasiswa_kimia') }}" style="text-decoration: none; color: inherit;">Klasifikasi Algoritma C45 Jurusan Kimia</a>
                     - Prediksi Jurusan Kimia
                </h4>
            </div>
            <form method="GET" action="{{ route('prediksi_mahasiswa_kimia') }}" id="filter-form">
                @csrf
                <div class="card-body">
