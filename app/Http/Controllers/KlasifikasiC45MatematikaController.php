...
class KlasifikasiC45MatematikaController extends Controller
{
    public function klasifikasi_dan_evaluation_mahasiswa_matematika(Request $request)
    {
...
return view('algoritma.klasifikasi_c45_dan_prediksi_matakuliah_matematika_mahasiswa', compact('outputData', 'total1', 'columnMapping','years', 'predictedLulus', 'year', 'result1', 'total2', 
