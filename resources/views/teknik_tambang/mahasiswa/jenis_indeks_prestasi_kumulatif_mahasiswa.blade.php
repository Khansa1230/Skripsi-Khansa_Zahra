                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4>Jumlah Mahasiswa Berdasarkan Indeks Prestasi Kumulatif</h4>
                            </div>
                            <form method="GET" action="{{ route('jumlah_mahasiswa_indeks_prestasi_kumulatif_teknik_tambang') }}" id="filter-form">
                                @csrf
                                <div class="card-body">
...
<script>
    ...
    const labels = query.map(item => item.kategoriipk); // Mengambil status dari query
