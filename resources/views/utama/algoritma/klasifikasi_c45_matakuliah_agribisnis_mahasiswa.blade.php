        ...
        <div class="card">
            <div class="card-header">
                <h4>
                    ...
                    <a href="{{ route('prediksi_mahasiswa_jurusan_agribisnis') }}" style="text-decoration: none; color: inherit;">Prediksi Jurusan Agribisnis</a>
                </h4>
            </div>
            <form method="GET" action="{{ route('klasifikasi_c45_mahasiswa_jurusan_agribisnis') }}" id="filter-form">
                @csrf
                <div class="card-body">
