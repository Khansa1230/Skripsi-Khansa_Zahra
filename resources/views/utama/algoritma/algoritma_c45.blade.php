...
<div class="page-content">
    ...
    <div class="col-12 col-lg-9">
        ...
        <div class="col-6 col-lg-3 col-md-6">
            <a href="{{ route('klasifikasi_c45_mahasiswa_jurusan_agribisnis') }}" class="card">
        ...
        <div class="col-6 col-lg-3 col-md-6">
            <a href="{{ route('klasifikasi_c45_mahasiswa_jurusan_biologi') }}" class="card">
                <div class="card-body px-4 py-4-5">
                    <div class="row align-items-center"> <!-- Tambahkan align-items-center -->
                        <div class="col-md-4 col-lg-12 col-xl-12 col-xxl-5 d-flex justify-content-start">
                            <div class="stats-icon purple mb-2">
        ...
        <div class="col-6 col-lg-3 col-md-6">
            <a href="{{ route('klasifikasi_c45_mahasiswa_jurusan_fisika') }}" class="card">
                <div class="card-body px-4 py-4-5">
                    <div class="row align-items-center"> <!-- Tambahkan align-items-center -->
                        <div class="col-md-4 col-lg-12 col-xl-12 col-xxl-5 d-flex justify-content-start">
                            <div class="stats-icon purple mb-2">
        ...
        <div class="col-6 col-lg-3 col-md-6">
            <a href="{{ route('klasifikasi_c45_mahasiswa_jurusan_kimia') }}" class="card">
                <div class="card-body px-4 py-4-5">
                    <div class="row align-items-center"> <!-- Tambahkan align-items-center -->
                        <div class="col-md-4 col-lg-12 col-xl-12 col-xxl-5 d-flex justify-content-start">
                            <div class="stats-icon purple mb-2">
        ...
        <div class="col-6 col-lg-3 col-md-6">
            <a href="{{ route('klasifikasi_c45_mahasiswa_jurusan_matematika') }}" class="card">
                <div class="card-body px-4 py-4-5">
                    <div class="row align-items-center"> <!-- Tambahkan align-items-center -->
                        <div class="col-md-4 col-lg-12 col-xl-12 col-xxl-5 d-flex justify-content-start">
                            <div class="stats-icon purple mb-2">
        ...
        <div class="col-6 col-lg-3 col-md-6">
            <a href="{{ route('klasifikasi_c45_mahasiswa_jurusan_sistem_informasi') }}" class="card">
                <div class="card-body px-4 py-4-5">
                    <div class="row">
                        <div class="col-md-4 col-lg-12 col-xl-12 col-xxl-5 d-flex justify-content-start">
                            <div class="stats-icon purple mb-2">
        ...
        <div class="col-6 col-lg-3 col-md-6">
            <a href="{{ route('klasifikasi_c45_mahasiswa_jurusan_teknik_informatika') }}" class="card">
                <div class="card-body px-4 py-4-5">
                    <div class="row">
                    <div class="col-md-4 col-lg-12 col-xl-12 col-xxl-5 d-flex justify-content-start">
                            <div class="stats-icon purple mb-2">
        ...
        <div class="col-6 col-lg-3 col-md-6">
            <a href="{{ route('klasifikasi_c45_mahasiswa_jurusan_teknik_tambang') }}" class="card">
                <div class="card-body px-4 py-4-5">
                    <div class="row">
                        <div class="col-md-4 col-lg-12 col-xl-12 col-xxl-5 d-flex justify-content-start">
                            <div class="stats-icon purple mb-2">
