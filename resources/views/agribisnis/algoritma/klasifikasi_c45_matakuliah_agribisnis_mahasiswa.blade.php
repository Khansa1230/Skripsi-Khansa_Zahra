@extends('agribisnis.kerangka.master')
    ...
    <section class="section">
        <div class="card">
            <div class="card-header">
                <h4>
                    Klasifikasi Algoritma C45 Jurusan Agribisnis - 
                    <a href="{{ route('prediksi_mahasiswa_agribisnis') }}" style="text-decoration: none; color: inherit;">Prediksi Jurusan Agribisnis</a>
                </h4>
            </div>
            <form method="GET" action="{{ route('klasifikasi_c45_mahasiswa_agribisnis') }}" id="filter-form">
                @csrf
                <div class="card-body">
