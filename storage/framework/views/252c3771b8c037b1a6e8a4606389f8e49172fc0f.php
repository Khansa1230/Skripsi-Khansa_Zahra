                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4>Jumlah Mahasiswa Berdasarkan Propinsi</h4>
                            </div>
                            <form method="GET" action="<?php echo e(route('jumlah_mahasiswa_propinsi')); ?>" id="filter-form">
                                <?php echo csrf_field(); ?>
                                <div class="card-body">
...
<script>
    ...
    const labels = query.map(item => item.propinsi); // Mengambil status dari query
...
<?php echo $__env->make('kerangka.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\skripsi\resources\views/mahasiswa/jenis_propinsi_mahasiswa.blade.php ENDPATH**/ ?>