        ...
        <div class="card">
            <div class="card-header">
                <h4>
                    ...
                    <a href="<?php echo e(route('prediksi_mahasiswa_fisika')); ?>" style="text-decoration: none; color: inherit;">Prediksi Jurusan Fisika</a>
                </h4>
            </div>
            <form method="GET" action="<?php echo e(route('klasifikasi_c45_dan_evaluation_mahasiswa_fisika')); ?>" id="filter-form">
                <?php echo csrf_field(); ?>
                <div class="card-body">
...
<?php echo $__env->make('kerangka.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\skripsi\resources\views/algoritma/klasifikasi_c45_dan_prediksi_matakuliah_fisika_mahasiswa.blade.php ENDPATH**/ ?>