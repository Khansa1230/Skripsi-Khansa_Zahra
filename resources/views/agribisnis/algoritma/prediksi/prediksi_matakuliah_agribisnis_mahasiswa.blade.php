    ...
    <section class="section">
        <div class="card">
            <div class="card-header">
                <h4>
                    <a href="{{ route('klasifikasi_c45_mahasiswa_agribisnis') }}" style="text-decoration: none; color: inherit;">Klasifikasi Algoritma C45 Jurusan Agribisnis</a>
                     - Prediksi Jurusan Agribisnis
                </h4>
            </div>
            <form method="GET" action="{{ route('prediksi_mahasiswa_agribisnis') }}" id="filter-form">
                @csrf
                <div class="card-body">
