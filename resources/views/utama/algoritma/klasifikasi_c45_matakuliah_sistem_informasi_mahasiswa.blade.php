    ...
    <section class="section">
        <div class="card">
            <div class="card-header">
                <h4>
                    Klasifikasi Algoritma C45 Jurusan Sistem Informasi - 
                    <a href="{{ route('prediksi_mahasiswa_jurusan_sistem_informasi') }}" style="text-decoration: none; color: inherit;">Prediksi Jurusan Sistem Informasi</a>
                </h4>
            </div>
            <form method="GET" action="{{ route('klasifikasi_c45_mahasiswa_jurusan_sistem_informasi') }}" id="filter-form">
                @csrf
                <div class="card-body">
