                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4>Jumlah Mahasiswa Berdasarkan Satuan Kredit Semester</h4>
                            </div>
                            <form method="GET" action="{{ route('jumlah_mahasiswa_satuan_kredit_semester_teknik_tambang') }}" id="filter-form">
                                @csrf
                                <div class="card-body">
...
<script>
    ...
    const labels = query.map(item => item.kategori_sks); // Mengambil status dari query
