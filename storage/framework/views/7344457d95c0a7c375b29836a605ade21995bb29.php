    ...
    <section class="section">
        <div class="card">
            <div class="card-header">
                <h4>
                    Klasifikasi Algoritma C45 Jurusan Teknik Tambang - 
                    <a href="<?php echo e(route('prediksi_mahasiswa_teknik_tambang')); ?>" style="text-decoration: none; color: inherit;">Prediksi Jurusan Teknik Tambang</a>
                </h4>
            </div>
            <form method="GET" action="<?php echo e(route('klasifikasi_c45_mahasiswa_teknik_tambang')); ?>" id="filter-form">
                <?php echo csrf_field(); ?>
                <div class="card-body">
                ...
                <div class="card-header">
                    ...
                    <div class="table-responsive">
                        <table class="table" id="table2">
                            ...
                            <tr>
                                <td class="fw-bold fs-5">Jenis Geologi Lapangan</td>
                                <td></td>
                                <td></td>
                                <td></td>
                                <td></td>
                            ...
                            <tr>
                                <td class="fw-bold fs-5">Jenis Kuliah Lapangan 1</td>
                                <td></td>
                                <td></td>
                                <td></td>
                                <td></td>
                            ...
                            <tr>
                                <td class="fw-bold fs-5">Jenis Kuliah Lapangan 2</td>
                                <td></td>
                                <td></td>
                                <td></td>
                                <td></td>
                            ...
                            <tr>
                                <td class="fw-bold fs-5">Jenis Kerja Nyata</td>
                                <td></td>
                                <td></td>
                                <td></td>
                                <td></td>
                            ...
                            <?php
                                ...
                                // Loop untuk menghitung total mahasiswa berdasarkan status
                                foreach ($total11 as $kategori => $item) {
                                    // Pastikan 'belum_lulus' dan 'lulus' ada dalam item
                                    $totalBelumLulus += $item['belum_lulus'] ?? 0; // Menggunakan null coalescing operator
                                    $totalLulus += $item['lulus'] ?? 0; // Menggunakan null coalescing operator
                                }
                            ...
                            <!-- Menampilkan data berdasarkan status -->
                            <?php $__currentLoopData = $total11; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kategori => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td><?php echo e($kategori); ?></td> <!-- Menampilkan status mahasiswa -->
                                    <td><strong><?php echo e($item['total_mahasiswa']); ?></strong></td>
                                    <td><strong><?php echo e($item['belum_lulus']); ?></strong></td>
                            ...
                            <tr>
                                <td class="fw-bold fs-5">Jenis Praktek Kuliah kerja Lapangan</td>
                                <td></td>
                                <td></td>
                                <td></td>
                                <td></td>
                            ...
                            <?php
                                ...
                                // Loop untuk menghitung total mahasiswa berdasarkan status
                                foreach ($total12 as $kategori => $item) {
                                    // Pastikan 'belum_lulus' dan 'lulus' ada dalam item
                                    $totalBelumLulus += $item['belum_lulus'] ?? 0; // Menggunakan null coalescing operator
                                    $totalLulus += $item['lulus'] ?? 0; // Menggunakan null coalescing operator
                                }
                            ...
                            <!-- Menampilkan data berdasarkan status -->
                            <?php $__currentLoopData = $total12; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kategori => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td><?php echo e($kategori); ?></td> <!-- Menampilkan status mahasiswa -->
                                    <td><strong><?php echo e($item['total_mahasiswa']); ?></strong></td>
                                    <td><strong><?php echo e($item['belum_lulus']); ?></strong></td>
                            ...
                            <?php
                                ...
                                // Loop untuk menghitung total mahasiswa berdasarkan status
                                foreach ($total13 as $kategori => $item) {
                                    // Pastikan 'belum_lulus' dan 'lulus' ada dalam item
                                    $totalBelumLulus += $item['belum_lulus'] ?? 0; // Menggunakan null coalescing operator
                                    $totalLulus += $item['lulus'] ?? 0; // Menggunakan null coalescing operator
                                }
                            ...
                            <!-- Menampilkan data berdasarkan status -->
                            <?php $__currentLoopData = $total13; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kategori => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td><?php echo e($kategori); ?></td> <!-- Menampilkan status mahasiswa -->
                                    <td><strong><?php echo e($item['total_mahasiswa']); ?></strong></td>
                                    <td><strong><?php echo e($item['belum_lulus']); ?></strong></td>
...
<?php echo $__env->make('kerangka.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\skripsi\resources\views/algoritma/klasifikasi_c45_matakuliah_teknik_tambang_mahasiswa.blade.php ENDPATH**/ ?>