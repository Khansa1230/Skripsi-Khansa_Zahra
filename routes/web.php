...
// Rute yang membutuhkan autentikasi dan berbagi data mahasiswa
  Route::middleware(['auth', 'shareMahasiswaData'])->group(function () {
    ...
    Route::get('/klasifikasi_c45_dan_evaluation_mahasiswa_teknik_informatika', [KlasifikasiC45TeknikInformatikaController::class, 'klasifikasi_dan_evaluation_mahasiswa_teknik_informatika'])->name('klasifikasi_c45_dan_evaluation_mahasiswa_teknik_informatika');
    Route::get('/klasifikasi_c45_dan_evaluation_mahasiswa_sistem_informasi', [KlasifikasiC45SistemInformasiController::class, 'klasifikasi_dan_evaluation_mahasiswa_sistem_informasi'])->name('klasifikasi_c45_dan_evaluation_mahasiswa_sistem_informasi');
    Route::get('/klasifikasi_c45_dan_evaluation_mahasiswa_agribisnis', [KlasifikasiC45AgribisnisController::class, 'klasifikasi_dan_evaluation_mahasiswa_agribisnis'])->name('klasifikasi_c45_dan_evaluation_mahasiswa_agribisnis');
    Route::get('/klasifikasi_c45_dan_evaluation_mahasiswa_fisika', [KlasifikasiC45FisikaController::class, 'klasifikasi_dan_evaluation_mahasiswa_fisika'])->name('klasifikasi_c45_dan_evaluation_mahasiswa_fisika');
    Route::get('/klasifikasi_c45_dan_evaluation_mahasiswa_matematika', [KlasifikasiC45MatematikaController::class, 'klasifikasi_dan_evaluation_mahasiswa_matematika'])->name('klasifikasi_c45_dan_evaluation_mahasiswa_matematika');
    Route::get('/klasifikasi_c45_dan_evaluation_mahasiswa_kimia', [KlasifikasiC45KimiaController::class, 'klasifikasi_dan_evaluation_mahasiswa_kimia'])->name('klasifikasi_c45_dan_evaluation_mahasiswa_kimia');
    Route::get('/klasifikasi_c45_dan_evaluation_mahasiswa_biologi', [KlasifikasiC45BiologiController::class, 'klasifikasi_dan_evaluation_mahasiswa_biologi'])->name('klasifikasi_c45_dan_evaluation_mahasiswa_biologi');
    Route::get('/klasifikasi_c45_dan_evaluation_mahasiswa_teknik_tambang', [KlasifikasiC45TeknikTambangController::class, 'klasifikasi_dan_evaluation_mahasiswa_teknik_tambang'])->name('klasifikasi_c45_dan_evaluation_mahasiswa_teknik_tambang');
