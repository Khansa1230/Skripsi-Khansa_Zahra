    ...
    <section class="section">
        <div class="card">
            <div class="card-header">
                <h4>Klasifikasi Algoritma C45 Jurusan Teknik Tambang</h4>
            </div>
            <form method="GET" action="<?php echo e(route('klasifikasi_c45_dan_evaluation_mahasiswa_teknik_tambang')); ?>" id="filter-form">
                <?php echo csrf_field(); ?>
                <div class="card-body">
...
<?php echo $__env->make('kerangka.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\skripsi\resources\views/algoritma/klasifikasi_c45_dan_prediksi_matakuliah_teknik_tambang_mahasiswa.blade.php ENDPATH**/ ?>