    ...
    <section class="section">
        ...
        <div class="card-header">
                <h4>
                    ...
                    <a href="{{ route('prediksi_mahasiswa_jurusan_kimia') }}" style="text-decoration: none; color: inherit;">Prediksi Jurusan kimia</a>
                </h4>
            </div>
            <form method="GET" action="{{ route('klasifikasi_c45_mahasiswa_jurusan_kimia') }}" id="filter-form">
                @csrf
                <div class="card-body">
