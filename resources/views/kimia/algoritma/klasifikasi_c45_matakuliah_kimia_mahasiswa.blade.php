        ...
        <div class="card">
            <div class="card-header">
                <h4>
                    ...
                    <a href="{{ route('prediksi_mahasiswa_kimia') }}" style="text-decoration: none; color: inherit;">Prediksi Jurusan Kimia</a>
                </h4>
            </div>
            <form method="GET" action="{{ route('klasifikasi_c45_mahasiswa_kimia') }}" id="filter-form">
                @csrf
                <div class="card-body">
