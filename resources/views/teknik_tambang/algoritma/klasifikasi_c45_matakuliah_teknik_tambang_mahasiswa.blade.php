    ...
    <section class="section">
        <div class="card">
            <div class="card-header">
                <h4>
                    Klasifikasi Algoritma C45 Jurusan Teknik Pertambangan - 
                    <a href="{{ route('prediksi_mahasiswa_teknik_tambang') }}" style="text-decoration: none; color: inherit;">Prediksi Jurusan Teknik Pertambangan</a>
                </h4>
            </div>
