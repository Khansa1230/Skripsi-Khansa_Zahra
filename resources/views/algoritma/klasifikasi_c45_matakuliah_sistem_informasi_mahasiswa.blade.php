        ...
        <div class="card">
            <div class="card-header">
                <h4>
                    ...
                    <a href="{{ route('prediksi_mahasiswa_sistem_informasi') }}" style="text-decoration: none; color: inherit;">Prediksi Jurusan Sistem Informasi</a>
                </h4>
            </div>
            <form method="GET" action="{{ route('klasifikasi_c45_mahasiswa_sistem_informasi') }}" id="filter-form">
                @csrf
                <div class="card-body">
