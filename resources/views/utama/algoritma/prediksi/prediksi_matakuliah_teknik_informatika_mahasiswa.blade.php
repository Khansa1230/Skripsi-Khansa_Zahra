    ...
    <section class="section">
        <div class="card">
            <div class="card-header">
                <h4>
                    <a href="{{ route('klasifikasi_c45_mahasiswa_jurusan_teknik_informatika') }}" style="text-decoration: none; color: inherit;">Klasifikasi Algoritma C45 Jurusan Teknik Informatika</a>
                     - Prediksi Jurusan Teknik Informatika
                </h4>
            </div>
            <form method="GET" action="{{ route('prediksi_mahasiswa_jurusan_teknik_informatika') }}" id="filter-form">
                @csrf
                <div class="card-body">
