                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4>Jumlah Mahasiswa Berdasarkan Jenis Matakuliah Teknik Informatika</h4>
                            </div>
                            <form method="GET" action="{{ route('jumlah_mahasiswa_matakuliah_teknik_informatika') }}" id="filter-form">
                                @csrf
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="matakuliah" id="matakuliah" name="matakuliah" class="form-control">
                                            <option name="" value="">Pilih matakuliah</option>    
