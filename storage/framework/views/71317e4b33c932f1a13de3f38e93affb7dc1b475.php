...
<div class="page-heading">
    <section class="section">
        ...
        <div class="card-header">
                <h4>
                    Klasifikasi Algoritma C45 Jurusan Teknik Informatika - 
                    <a href="<?php echo e(route('prediksi_mahasiswa_teknik_informatika')); ?>" style="text-decoration: none; color: inherit;">Prediksi Jurusan Teknik Informatika</a>
                </h4>
            </div>
                <?php echo csrf_field(); ?>
                <div class="card-body">
...
<?php echo $__env->make('kerangka.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\skripsi\resources\views/algoritma/klasifikasi_c45_matakuliah_teknik_informatika_mahasiswa.blade.php ENDPATH**/ ?>