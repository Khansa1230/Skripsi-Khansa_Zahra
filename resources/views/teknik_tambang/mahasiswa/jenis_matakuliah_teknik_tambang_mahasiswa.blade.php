@extends('teknik_tambang.kerangka.master')
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4>Jumlah Mahasiswa Berdasarkan Jenis Matakuliah Teknik Pertambangan</h4>
                            </div>
                            <form method="GET" action="{{ route('jumlah_mahasiswa_matakuliah_teknik_tambang') }}" id="filter-form">
                                @csrf
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="matakuliah" id="matakuliah" name="matakuliah" class="form-control">
                                            <option name="geologi" value="geologi">Geologi</option>
                                            <option name="pkl" value="pkl">Praktek Kerja Lapangan</option>
                                            <option name="lapangan1" value="lapangan1">Kuliah Lapangan 1</option>
                                            <option name="lapangan2" value="lapangan2">Kuliah Lapangan 2</option>
