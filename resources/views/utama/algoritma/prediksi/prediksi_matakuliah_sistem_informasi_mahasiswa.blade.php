    ...
    <section class="section">
        <div class="card">
            <div class="card-header">
                <h4>
                    <a href="{{ route('klasifikasi_c45_mahasiswa_jurusan_sistem_informasi') }}" style="text-decoration: none; color: inherit;">Klasifikasi Algoritma C45 Jurusan Sistem Informasi</a>
                     - Prediksi Jurusan Sistem Informasi
                </h4>
            </div>
            <form method="GET" action="{{ route('prediksi_mahasiswa_jurusan_sistem_informasi') }}" id="filter-form">
                @csrf
                <div class="card-body">
